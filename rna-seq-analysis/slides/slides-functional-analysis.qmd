...
::: {.columns}
![](ora.png){fig-align="center" width="100%"}
:::
...
## 7.2 网络图（Cnetplot）{.small}

::: {.columns}
![](cnetplot.png){fig-align="center" width="40%"}
:::
...
::: {.columns}
![](gseaplot.png){fig-align="center" width="40%"}
:::
...
1. 以 batch 为协变量完成 ATC vs PTV 的差异表达分析
2. 对差异基因进行GO和KEGG富集分析，撰写结果描述
3. 使用点图和cnetplot可视化富集结果
4. 展示Top1的GSEA结果，并解读其生物学意义

- 主要形式为 `.R`/`.Rmd/Qmd`脚本，需包含注释和结果输出
