...
本课程面向**生物信息学专业**大二本科生，系统讲授 **R语言基础语法** 与 **(R)Markdown文档编写** 技术。通过"2学时理论讲授 + 2学时实验操作"的紧凑安排，帮助学生：
...
[📊 幻灯片：R基础](slides/slides-r-basics.html){.btn .btn-secondary .btn-lg .me-2}
[📊 幻灯片：R Markdown](slides/slides-rmarkdown.html){.btn .btn-secondary .btn-lg .me-2}
